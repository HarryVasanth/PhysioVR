...
public class MyoCommandList {
  ...
  public byte[] sendVibration3() {
    ...
    send_bytes_data =
      new byte[] { command_vibrate, payload_vibrate, vibrate_type };
  ...
  public byte[] sendUnLock() {
    ...
    send_bytes_data =
      new byte[] { command_unlock, payload_unlock, unlock_type };
  ...
  public byte[] sendUnSleep() {
    ...
    send_bytes_data =
      new byte[] { command_sleep_mode, payload_unlock, never_sleep };
  ...
  public byte[] sendNormalSleep() {
    ...
    send_bytes_data =
      new byte[] { command_sleep_mode, payload_unlock, normal_sleep };
