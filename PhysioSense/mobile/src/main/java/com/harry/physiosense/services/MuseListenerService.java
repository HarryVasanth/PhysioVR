...
public class MuseListenerService {
  ...
  public class ConnectionListener extends MuseConnectionListener {
    ...
    public void receiveMuseConnectionPacket(MuseConnectionPacket p) {
      ...
      final String status =
        p.getPreviousConnectionState().toString() + " -> " + current;
      final String full =
        "Muse " + p.getSource().getMacAddress() + " " + status;
  ...
  public class DataListener extends MuseDataListener {
    ...
    private void updateEeg(final ArrayList<Double> data) {
      ...
      Log.d(
        "EEG Updated =>",
        " EEG1: " + eeg1 + " EEG2:" + eeg2 + " EEG3: " + eeg3 + " EEG4: " + eeg4
      );
    }
    ...
    private void updateAlphaRelative(final ArrayList<Double> data) {
      ...
      Log.d(
        "Elements Updated =>",
        " E1: " + elm1 + " E2:" + elm2 + " E3: " + elm3 + " E4: " + elm4
      );
    }
  }
