...
public class MyoGattCallback extends BluetoothGattCallback {
  ...
  /** Service ID */
  private static final String MYO_CONTROL_ID =
    "d5060001-a904-deb9-4748-2c7f4a124842";
  private static final String MYO_EMG_DATA_ID =
    "d5060005-a904-deb9-4748-2c7f4a124842";
  /** Characteristics ID */
  private static final String MYO_INFO_ID =
    "d5060101-a904-deb9-4748-2c7f4a124842";
  private static final String FIRMWARE_ID =
  ...
  private static final String CLIENT_CHARACTERISTIC_CONFIG =
  ...
  public void onServicesDiscovered(BluetoothGatt gatt, int status) {
    ...
    if (status == BluetoothGatt.GATT_SUCCESS) {
      // Find GATT Service
      BluetoothGattService service_emg = gatt.getService(
        UUID.fromString(MYO_EMG_DATA_ID)
      );
      if (service_emg == null) {
        ...
        mCharacteristic_emg0 =
          service_emg.getCharacteristic(UUID.fromString(EMG_0_ID));
        if (mCharacteristic_emg0 == null) {
          callback_msg = "Not Found EMG-Data Characteristic";
        } else {
          // Setting the notification
          boolean registered_0 = gatt.setCharacteristicNotification(
            mCharacteristic_emg0,
            true
          );
          if (!registered_0) {
            ...
            BluetoothGattDescriptor descriptor_0 = mCharacteristic_emg0.getDescriptor(
              UUID.fromString(CLIENT_CHARACTERISTIC_CONFIG)
            );
            if (descriptor_0 != null) {
              descriptor_0.setValue(
      ...
      BluetoothGattService service = gatt.getService(
        UUID.fromString(MYO_CONTROL_ID)
      );
      if (service == null) {
        ...
        if (characteristic == null) {} else {
          ...
          if (
            (readCharacteristicQueue.size() == 1) &&
...
*/
        ...
        mCharacteristic_command =
          service.getCharacteristic(UUID.fromString(COMMAND_ID));
        if (mCharacteristic_command == null) {} else {
  ...
  public void onDescriptorWrite(
    ...
    if (descriptorWriteQueue.size() > 0) mBluetoothGatt.writeDescriptor(
      descriptorWriteQueue.element()
    ); else if (
      readCharacteristicQueue.size() > 0
  ...
  public void onCharacteristicRead(
    ...
    if (status == BluetoothGatt.GATT_SUCCESS) {
      if (UUID.fromString(FIRMWARE_ID).equals(characteristic.getUuid())) {
        ...
        UUID.fromString(MYO_INFO_ID).equals(characteristic.getUuid())
      ) {
    ...
    if (readCharacteristicQueue.size() > 0) mBluetoothGatt.readCharacteristic(
      readCharacteristicQueue.element()
    );
  }
  ...
  static final long NEVER_SLEEP_SEND_TIME = 10000; // Milli Second
  ...
  public void onCharacteristicChanged(
    ...
    if (EMG_0_ID.equals(characteristic.getUuid().toString())) {
        ...
        new Runnable() {
          ...
          public void run() {
            ...
            while (0 < number) {
              ...
              if (number != 0) {
                for (
                  int setDatalistIndex = 0;
                  setDatalistIndex < 8;
                  setDatalistIndex++
                ) {
                  dataList1_a[setDatalistIndex][number] =
                    dataList1_a[setDatalistIndex][number - 1];
                }
              }
              ...
              if (number != 0) {
                for (
                  ...
                  dataList1_b[setDatalistIndex][number] =
                    dataList1_b[setDatalistIndex][number - 1];
                }
              }
            ...
            if (nowButton != null) {
              ...
              line.setColor(
                ((ColorDrawable) nowButton.getBackground()).getColor()
              ); // 線の色をSet
            }
      ...
      if (
        systemTime_ms > last_send_never_sleep_time_ms + NEVER_SLEEP_SEND_TIME
      ) {
